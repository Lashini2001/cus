...
<fieldset style="height: 250px; width: 450px; background-color: #f2f2f2;">
        
	<form action="log" method = "post"> <br>
	
	  <h1>Customer Validate Page</h1><br>
		username : <input type= "text" name = "username" pattern="[^ @]*@[^ @]*" required><br><br>
		password : <input type = "password" name = "password" required><br><br>
		
		<input type ="submit"  name="submit" value ="login" class="formbold-btn formbold-btn-primary formbold-btn-lg">
